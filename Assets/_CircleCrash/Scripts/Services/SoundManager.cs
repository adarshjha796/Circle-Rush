...
namespace SgLib
{
    ...
    public class SoundManager : MonoBehaviour
    {
        ...
        public Sound traffic;
        public Sound button;
        public Sound carBreak;
        public Sound coin;
        ...
        public PlayingState MusicState { get { return _musicState; } }

        private AudioSource _audioSource;
        private PlayingState _musicState = PlayingState.Stopped;
        ...
        {
            if (_musicState == PlayingState.Playing)
            {
                AudioSource.Pause();
                _musicState = PlayingState.Paused;
            }    
        }
        ...
        {
            if (_musicState == PlayingState.Paused)
            {
                AudioSource.UnPause();
                _musicState = PlayingState.Playing;
            }
        ...
        {
            AudioSource.Stop();
            _musicState = PlayingState.Stopped;
        }
